...
upload_fip_report(report_filename) {
    ...
    ClickWait(1775, 720, 1, default_wait)  ; Click in drop down to import report
    ...
    ClickWait(930, 655, 1, default_wait)  ; Click to bring up file selection window
...
get_report_name(report_filename) {
    return RegExReplace(report_filename, "\.zip")
}
